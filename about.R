...
function(){
  tabPanel("About",
           ...
           p("This web application is a country-specific implementation of the estimation approach for contraceptive prevalence and unmet need for family planning used by the United Nations Population Division (UNPD).",
             "Refer to UNPD's ",
             a("World Contraceptive Use 2012", 
               href = "http://www.un.org/esa/population/publications/WCU2012/MainFrame.html", target = "_blank"),
          ...
          #   ,"The default database loaded in FPET is the UNPD World Contraceptive Use 2012 database, which is available at ",
          #   a("World Contraceptive Use 2012.", 
          #     href = "http://www.un.org/esa/population/publications/WCU2012/MainFrame.html", target = "_blank")),
           ),
           ...
           p(em(paste("Last updated: 17 Jun 2014")))
  )
}
